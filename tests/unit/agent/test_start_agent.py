...
def _load_start_agent_module(monkeypatch):
    ...
    config_stub.AGENT_CONTEXT_COMPACTION_INTERVAL = 8
    config_stub.AGENT_CONTEXT_COMPACTION_OVERLAP_SIZE = 2
    config_stub.AGENT_CONTEXT_TOKEN_THRESHOLD = 16000
    config_stub.AGENT_CONTEXT_EVENT_RETENTION_SIZE = 12
...
def test_start_agent_exports_app_with_context_compaction_config(monkeypatch) -> None:
    ...
    assert module.app.events_compaction_config.compaction_interval == 8
    assert module.app.events_compaction_config.overlap_size == 2
