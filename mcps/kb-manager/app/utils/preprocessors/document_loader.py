...
class DocumentLoader:
    ...
    def prepare_docs_texts(self, kb_id: Optional[str]=None, map_true: bool=True, index_answers: bool=False,
                           user_id: str="robot", filepath:str="") -> Tuple[List[Dict], Dict, int, int]:
        """
        ...
        if map_true:
            ...
            return self._gather_documents(index_answers, kb_id, user_id, filepath)
    ...
    def _gather_documents(self, index_answers: bool, kb_id, user_id, filepath) -> Tuple[List[Dict], Dict, int, int]:
        """
