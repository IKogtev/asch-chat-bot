...
# CONTEXT COMPACTION
# =============================================================================
AGENT_CONTEXT_COMPACTION_INTERVAL = int(os.getenv("AGENT_CONTEXT_COMPACTION_INTERVAL", "36"))
...
AGENT_CONTEXT_EVENT_RETENTION_SIZE = int(os.getenv("AGENT_CONTEXT_EVENT_RETENTION_SIZE", "36"))
