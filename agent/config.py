...
# JSON-список документов: штраф за повтор токенов вреден (поля/структура повторяются).
DOC_SEARCH_PRESENCE_PENALTY = float(os.getenv("DOC_SEARCH_PRESENCE_PENALTY", 0.0))
...
OWASP_MAX_OUTPUT_TOKENS = int(os.getenv("OWASP_MAX_OUTPUT_TOKENS", 3000))
...
DISPATCHER_MAX_OUTPUT_TOKENS = int(os.getenv("DISPATCHER_MAX_OUTPUT_TOKENS", 4000))
SMALLTALK_MAX_OUTPUT_TOKENS = int(os.getenv("SMALLTALK_MAX_OUTPUT_TOKENS", 2000))
PRODUCT_CONTENT_MAX_OUTPUT_TOKENS = int(os.getenv("PRODUCT_CONTENT_MAX_OUTPUT_TOKENS", 10000))
PRODUCT_FORMATTER_MAX_OUTPUT_TOKENS = int(os.getenv("PRODUCT_FORMATTER_MAX_OUTPUT_TOKENS", 6000))
ADVISOR_MAX_OUTPUT_TOKENS = int(os.getenv("ADVISOR_MAX_OUTPUT_TOKENS", 25000))
KB_ANSWER_MAX_OUTPUT_TOKENS = int(os.getenv("KB_ANSWER_MAX_OUTPUT_TOKENS", 6000))
DOC_SEARCH_MAX_OUTPUT_TOKENS = int(os.getenv("DOC_SEARCH_MAX_OUTPUT_TOKENS", 6000))
...
ADVISOR_TOP_N = int(os.getenv("ADVISOR_TOP_N", "5"))
